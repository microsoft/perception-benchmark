...
from .tmultimae_utils import Block, trunc_normal_

__all__ = [
    "pretrain_tmultimae_base",
    "pretrain_tmultimae_large",
    "tmultivit_base",
    "tmultivit_large",
]


class tMultiMAE(nn.Module):
    """temporal MultiMAE: Multi-task Multi-modal Masked Autoencoder
    ...
    def generate_input_info(self, input_task_tokens, image_size):
        ...
        for domain, tensor in input_task_tokens.items():
            ...
            d = {
                ...
                "has_3d_posemb": True,  # TODO: Modify when adding non-2D tasks
                "start_idx": i,
    ...
    def forward(
        ...
        if "rgb" in x:
            ...
            B, C, T, H, W = x["depth"].shape
        else:
            raise NotImplementedError("input does not contain rgb or depth")
